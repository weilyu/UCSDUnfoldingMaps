...
public class EarthquakeCityMap extends PApplet {
    ...
    private void addKey() {
        ...
        ellipse(50, 225, 5, 5);
        fill(150, 30, 30);
        triangle(60-8, 285-10-5, (float)(60 + 5 * 1.73-8), (float)(285 ), (float)(60 - 5 * 1.73-8), (float)(285 ));
    ...
    private void printQuakes() {
        ...
        HashMap<String, Integer> countryNum = new HashMap<>();
        ...
        for (Marker qm : quakeMarkers) {
            if (qm instanceof LandQuakeMarker) {
                ...
                if (!countryNum.containsKey(country)) {
                    countryNum.put(country, 1);
                } else {
                    int num = countryNum.get(country);
                    countryNum.put(country, num + 1);
                }
            } else countOceanQuakes++;
        }
        System.out.println(countryNum);
        System.out.println("Ocean quake happened " + countOceanQuakes + " times.");
    }
