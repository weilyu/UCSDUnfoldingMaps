...
public class EarthquakeCityMap extends PApplet {
    ...
    //return the color depending on the magnitude
    private int colorMarker(PointFeature feature) {
        Float magnitude = Float.valueOf(feature.getProperty("magnitude").toString());
